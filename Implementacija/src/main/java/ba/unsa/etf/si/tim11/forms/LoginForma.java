...
public class LoginForma {
	...
	private void prijavaKorisnika() {
		...
		if (KorisnikRepository.korisnikAutenticiran(txtUsername.getText(), passwordField.getText())) {
			JOptionPane.showMessageDialog(null, "Vaša prijava je uspješna.", "Dobrodošao " + txtUsername.getText(),
			...
			JOptionPane.showMessageDialog(null, "Molimo provjerite vaše podatke za prijavu.", "Neuspješna prijava",
					JOptionPane.INFORMATION_MESSAGE);
		}
	}
